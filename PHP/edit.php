    ...
    <div class="container p-4">
      ...
      <hr>
        ...
        <?php
          ...
          $query = "UPDATE `student_list` SET `ID`='$id',`Name`='$name',`Age`='$age',`School`='$school',`Class`='$class',`Divison`='$divison',`Status`='$status' WHERE `ID` = $id";
          $result = mysqli_query($mysql, $query);
      ...
      <form method="post">
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  <input type="text" id="inputName" class="form-control w-25 border-secondary" name="name" value="<?php echo $row['Name'];?>">
              </div>
          </div>
          <div class="form-group row">
              <label for="inputDate" class="col-sm-2 col-form-label">Date of Birth</label>
              <div class="col-sm-10">
                  <input type="date" id="inputDate" class="form-control w-25 border-secondary" name="age" value="<?php echo $row['Age'];?>">
              </div>
          </div>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  <select class="form-control w-25 border-secondary" id="inputSchool" name="school">
                      <option selected><?php echo $row['School'];?></option>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  <select class="form-control w-25 border-secondary" id="inputClass" name="class">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10">
                  <select class="form-control w-25 border-secondary" id="inputDivison" name="divison">
                      <option selected><?php echo $row['Divison'];?></option>
                      <option>A</option>
                      <option>B</option>
                      <option>C</option>
                  </select>
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-10 pt-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status" id="inputStatus" value="Active" checked>
                    <label class="form-check-label" for="inlineRadio1">Active</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status" id="inputStatus" value="Inactive">
